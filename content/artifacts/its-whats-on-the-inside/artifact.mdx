...
<div className="my-10 grid grid-cols-2 gap-4 md:grid-cols-3">
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con2.jpg" alt="Concept study" className="block aspect-[2/3] w-full rounded-md object-cover object-right-bottom" loading="lazy" />
