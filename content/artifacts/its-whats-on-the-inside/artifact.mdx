...
<div className="my-10 grid grid-cols-2 gap-4 md:grid-cols-3">
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con1.jpg" alt="Concept study 1" className="block h-auto w-full rounded-md" loading="lazy" />
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con2.jpg" alt="Concept study 2" className="block h-auto w-full rounded-md" loading="lazy" />
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con3.jpg" alt="Concept study 3" className="block h-auto w-full rounded-md" loading="lazy" />
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con4.jpg" alt="Concept study 4" className="block h-auto w-full rounded-md" loading="lazy" />
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con5.jpg" alt="Concept study 5" className="block h-auto w-full rounded-md" loading="lazy" />
  <img src="/possibilia/artifacts/its-whats-on-the-inside/con6.jpg" alt="Concept study 6" className="block h-auto w-full rounded-md" loading="lazy" />
</div>
