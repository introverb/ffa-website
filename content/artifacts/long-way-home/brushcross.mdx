...
_by Andres Osorio and Olli Payne_

<div className="my-10 grid grid-cols-1 gap-4 md:grid-cols-2">
  <img src="/possibilia/artifacts/long-way-home/bushcross2.jpg" alt="Brushcross concept art" className="block aspect-[4/3] w-full rounded-md object-cover" loading="lazy" />
  <img src="/possibilia/artifacts/long-way-home/bushcross3.jpg" alt="Brushcross concept art" className="block aspect-[4/3] w-full rounded-md object-cover" loading="lazy" />
</div>
