...
// and the door check-in kiosk (chromeless end to end — see
// PageFrame's CHROMELESS_ROUTES for the matching nav half of this).
// Footer stays a server component; it's passed in as a prop so this
// client wrapper never has to import it directly.
